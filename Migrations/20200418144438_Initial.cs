        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Strikes = table.Column<int>(nullable: false, defaultValue: 0)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfBorrow = table.Column<DateTime>(nullable: true, defaultValue: null),
                    DateOfReturn = table.Column<DateTime>(nullable: true, defaultValue: null),
                    ClientId = table.Column<int>(nullable: true, defaultValue: null),
                    PublisherId = table.Column<int>(nullable: true, defaultValue: null)
                },
                constraints: table =>
                {
